              ...
              <div className="lg:col-span-8 p-6 sm:p-8 rounded-3xl bg-white border border-slate-200 shadow-xl space-y-6">
                ...
                <form onSubmit={handleDirectSupabaseBooking} className="space-y-6">
                  ...
                  <div className="space-y-4 pt-2">
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 pb-2 border-b border-slate-200">
                      ...
                      <button
                        ...
                        className="inline-flex items-center gap-1.5 text-xs font-bold px-3 py-1.5 rounded-lg bg-slate-100 hover:bg-slate-200 text-slate-800 border border-slate-300 transition-all cursor-pointer disabled:opacity-50"
                      >
                        {isDetectingLocation ? (
                          <>
                          ...
                          <>
                            <LocateFixed className="w-3.5 h-3.5 text-black" />
                      ...
                      <div className="p-3 rounded-xl bg-emerald-50 border border-emerald-200 text-emerald-800 text-xs flex items-center justify-between gap-2">
                        <div className="flex items-center gap-2 truncate">
                          ...
                          <span className="font-bold truncate">
                            GPS Captured: {formData.gpsCoords?.latitude.toFixed(4)}, {formData.gpsCoords?.longitude.toFixed(4)}
                          </span>
                        </div>
                        <a
                  ...
                  <button
                    ...
                    className="w-full py-4 px-6 rounded-xl bg-[#5337E1] hover:bg-[#462ec4] text-white font-extrabold text-base uppercase tracking-wider shadow-lg shadow-[#5337E1]/25 transition-all hover:scale-[1.01] active:scale-[0.99] flex items-center justify-center gap-3 cursor-pointer disabled:opacity-70 disabled:cursor-not-allowed"
                  >
                    {isSubmitting ? (
                      <>
