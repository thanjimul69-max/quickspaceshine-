      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 space-y-10">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-3">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-black text-slate-900 tracking-tight">
            See The <span className="text-black">QSS Steam Magic</span>
          </h2>
        ...
        <div className="max-w-4xl mx-auto w-full px-0 sm:px-2">
          ...
          >
            ...
            <div className="absolute inset-0 bg-gradient-to-br from-slate-900 via-slate-950 to-black flex flex-col justify-center items-center text-center p-4 sm:p-8">
              ...
              <div className="relative z-10 space-y-2.5 sm:space-y-4 max-w-md">
                <div className="p-2.5 sm:p-4 rounded-full bg-white/10 border border-white/20 text-white inline-flex shadow-xl shadow-black/20">
                ...
                <p className="text-[11px] sm:text-xs md:text-sm text-slate-300 font-medium leading-relaxed max-w-sm mx-auto">
                ...
                <div className="inline-flex items-center gap-1.5 px-2.5 sm:px-3 py-0.5 sm:py-1 rounded-full bg-white/10 text-white text-[10px] sm:text-xs font-bold border border-white/20">
              ...
              {/* Label Badge */}
              <span className="absolute top-3 right-3 sm:top-5 sm:right-5 px-2.5 sm:px-3 py-1 sm:py-1.5 rounded-lg sm:rounded-xl bg-black text-white font-black text-[10px] sm:text-xs uppercase tracking-wider border border-slate-700 shadow-lg">
                AFTER (QSS Clean)
              </span>
            </div>
            ...
            <div
              ...
              className="absolute top-0 bottom-0 w-1 bg-gradient-to-b from-slate-400 via-white to-slate-400 z-20 shadow-[0_0_15px_rgba(0,0,0,0.8)] pointer-events-none"
            >
              <div className="absolute top-1/2 -translate-y-1/2 -translate-x-1/2 w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-white border-2 border-black flex items-center justify-center text-black shadow-2xl">
          ...
          <div className="mt-3 sm:mt-4 flex flex-col sm:flex-row items-center justify-between gap-1.5 text-[11px] sm:text-xs text-slate-500 font-medium px-1 text-center">
            ...
            <span className="text-black font-bold">100°C High-Pressure Thermal Steam Power</span>
